...
export const useKeywordAnalysisData = (id:number) => {
    const {data: keywordAnalysisData, isPending, isError, isSuccess} = useQuery({
...
export const useKeywordIdeas = (id:number)=> {
    const {data: keywordIdeas, isPending, isError, isSuccess} = useQuery({
...
export const useKeywordmutation = (payload:any,id:number, changeState: ()=> void) => {
