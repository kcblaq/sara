...
export default function HomePage() {
     return (
          <main className="w-full snap-y">
               <div className="top-0 left-0 fixed w-full">
                    <Nav />
                    <hr className="w-full" />
               </div>
               <section className=" h-screen pt-32 p-2 flex flex-col items-center justify-center gap-12 bg-secondary">
               ...
               <section className="h-screen snap-start flex items-center justify-center bg-green-300">
                    Why use webmaxi
               </section>
