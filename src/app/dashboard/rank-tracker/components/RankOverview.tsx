    ...
    return (
        <main className='grid w-full h-full items-start content-start gap-6 my-10 mb-20 overflow-auto'>
            <section className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                <OrganicTrafficCard />
                <Card title={'Search visibility'} amount={undefined} style={''} percent={undefined} chart={undefined} />
                <Card title={'Average position'} amount={undefined} style={''} percent={undefined} chart={undefined} />

            </section>
            <section className='grid grid-cols-3 gap-8 '>

                <div className={` col-span-1 grid p-6 gap-3 rounded-md border shadow-sm w-full`}>
                    <TitleWithoutUnderline title={'Keyword ranking '} info={'Keyword ranking '} />
                        ...
                        <table className='py-4 w-full'>
                            <thead className=' bg-[#EAECF0] h-12 rounded-md'>
                                <tr className='rounded-md'>
                                    <th className='font-medium text-xs text-[#475467] rounded-tl-xl text-left p-2'>Positions</th>
                                    <th className='font-medium text-xs text-[#475467] text-left p-2 '>
                                        <span className={`flex items-center gap-1`}> Number <ButtonWithTitle info={'More or less keywords'} /></span>
                                    </th>
                                    <th className='font-medium text-xs text-[#475467] rounded-tr-xl text-left p-2 '>
                                        <span className={`flex items-center gap-1`}> Changes <ButtonWithTitle info={'Changes in rank position'} /></span>
                            ...
                            <tbody>
                                <tr className=' border-b'>
                                    ...
                                    <td className='  p-2 rounded-full'><span className={`bg-green-200 p-2 rounded-full`}>60</span> </td>
                                </tr>
                                <tr className='border-b'>
                                    <td className=' p-2 '>0 - 3</td>
                                    <td className=' p-2 '>517</td>
                ...
                <div className={` col-span-2 grid p-6 gap-3 rounded-md border shadow-sm w-full`}>
                    <TitleWithoutUnderline title={'Position distributions '} info={'Position distributions'} />
                    <BarChartSingle labels={[]} data={[]} xAxisLabel='Month' yAxisLabel='Number of Visitors' />
                    </div>
