    ...
    stage == 0 ?
      <main className='grid w-full h-full items-start content-start gap-6 my-10 mb-20 overflow-auto'>
        <section className={`flex flex-col gap-4 text-[#101828] `}>
          <h1 className={`font-semibold text-4xl 2xl:text-5xl`}> Keyword explorer</h1>
          <p className={`text-lg 2xl:text-xl`}> Explore thousands of keywords and research smart keyword suggestions</p>
        </section>
        <section className="flex items-start gap-8 justify-between">
          <div className="flex flex-col gap-2 ">
            <label className=" font-medium " htmlFor="keyword">Enter keywords separated by commas</label>
            <textarea rows={5} cols={70} placeholder="e.g. dog food, pet care, how to care for your dog..." className=" p-2 border rounded-md ">
        ...
        <section className="flex items-start gap-8 justify-between">
          <div className="flex flex-col gap-2 ">
            <label className=" font-medium " htmlFor="keyword">Enter base keyword and get smart keyword suggestions </label>
            <textarea rows={2} cols={70} placeholder="e.g. dog food, pet care, how to care for your dog..." className=" p-2 border rounded-md ">
      ...
      <main className='grid w-full h-full items-start content-start gap-6 my-10 mb-20 overflow-auto'>
        ...
        <section className={`flex  w-full items-center gap-4 text-[#101828] `}>
