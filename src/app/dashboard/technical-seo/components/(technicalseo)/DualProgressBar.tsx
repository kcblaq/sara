...
export const QuadProgressBar: React.FC<QuadProgressBarProps> = ({ metric1Percentage, metric2Percentage, metric3Percentage, metric4Percentage }) => {
    ...
    return (
        <section className="flex items-center h-4 border w-full rounded-3xl">
            <div style={metric1Style} className="h-full bg-[#12B76A] rounded-l-3xl"></div>
            <div style={metric2Style} className="h-full bg-[#2E90FA]"></div>
            <div style={metric3Style} className="h-full bg-[#D1E9FF]"></div>
            <div style={metric4Style} className="h-full bg-[#FEDF89] rounded-r-3xl"></div>
        </section>
    );
};
