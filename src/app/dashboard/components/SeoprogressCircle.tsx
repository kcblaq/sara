    ...
    <div className=" rounded-full flex items-center justify-center">
      <div className="z-0">
        ...
        <CircularProgressbarWithChildren value={averageSeo ?? 0} className='' styles={{
              ...
              <div className="flex flex-col">
                <p className='text-gray-600 text-center text-sm'>Total links found </p>
                <p className='text-gray-900 text-center text-5xl'> {crawled?.crawled?.total} </p>
              </div>
            </CircularProgressbarWithChildren>
      </div>
    </div>
    ...
    <div className="grid p-2 md:p-4 col-span-1 h-full justify-items-start  rounded-md w-full border ">
      ...
      <div className="p-2 flex w-full ">
        ...
        <div className="flex h-full flex-col justify-end">
          <p className=' flex items-center text-xs text-[#475467]'> <span className="text-green-300"><GoDotFill />  </span> {`Crwaled(${crawled?.crawled.crawled})`} </p>
          <p className=' flex items-center text-xs text-[#475467]'> <span className="text-green-100"><GoDotFill /></span> {`Uncrawled(${crawled?.crawled.uncrawled})`} </p>
        </div>
      </div>
    </div>
  );
