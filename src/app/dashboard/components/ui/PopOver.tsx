    ...
    <Popover className={` z-50`} suppressHydrationWarning>
      {({ open }) => (
        <>
          ...
          <PopoverPanel anchor="bottom" className="flex flex-col bg-white z-50  shadow-md p-3">
            <Button variant='cancel' onClick={logout} className='hover:bg-primary hover:text-white w-full px-3'>Logout</Button>
          </PopoverPanel>
        </>
      )}
    </Popover>
